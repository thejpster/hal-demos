...
main(void)
{
    ...
    //
    UARTprintf("CPU\tRemaining\tSSI TX\t\t\t   UART\n");
    ...
    //
    ui32PrevXferCount = g_ui32SSITxCount;
    ...
    while(1)
    {
        ...
        if(g_ui32Seconds != ui32PrevSeconds)
        {
            ...
            // second.
            //
            ui32XfersCompleted = g_ui32SSITxCount - ui32PrevXferCount;
            ...
            //
            ui32BytesTransferred = ui32XfersCompleted * SSI_BUFFER_SIZE * 4;
